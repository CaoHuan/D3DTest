...
class Tutorial : public D3DBase
{
public:
	Tutorial(HINSTANCE hInstance, int width, int height, bool windowed, D3DDEVTYPE deviceType) :D3DBase(hInstance, width, height, windowed, deviceType)
	{
	}
...
public:
	Cube(HINSTANCE hInstance, int width, int height, bool windowed, D3DDEVTYPE deviceType) :D3DBase(hInstance, width, height, windowed, deviceType)
		, vb(NULL)
		, ib(nullptr)
	{}
...
{
	D3DBase* base = new Cube(hInstance, Width, Height, true, D3DDEVTYPE_HAL);
	base->Setup();
	base->Run();
